    ...
    <body class="bg-light">
        ...
        <div class="py-5">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="formLogin" method="POST" action="php/control/controleLocadora.php" onsubmit="return do_login();">
        ...
        <?php include_once 'php/util/modalSuccess.php'; ?>
        <script src="js/jquery-3.3.1.js"></script>
        <script src="js/popper.min.js"></script>
        <script src="js/bootstrap.min.js"></script>
        <script src="js/controleLogin.js" type="text/javascript"></script>
    </body>
